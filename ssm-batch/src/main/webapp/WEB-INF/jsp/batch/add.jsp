...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs nav-justified" role="tablist">
			...
			<li class="active"><a href="<%=basePath%>/batch/add">新增任务</a></li>
				...
				<form role="form" id="form1" action="<%=basePath%>batch/addBatchJobDefine" method="post">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="jobId" name="jobId" placeholder="Enter jobId">
							<!-- <span class="glyphicon glyphicon-ok form-control-feedback"></span> -->
						</div>
						<div class="form-group">
							<label for="proName">proName</label> 
							<input type="text" class="form-control" id="proName" name="proName" placeholder="Enter proName">
						</div>
						<div class="form-group">
							<label for="profileFlag">text profileFlag</label> 
							<input type="text" class="form-control" id="profileFlag" name="profileFlag" placeholder="Enter profileFlag">
						</div>
						<div class="form-group">
							<label for="profileId">profileId</label> 
							<input type="text" class="form-control" id="profileId" name="profileId" placeholder="profileId">
						</div>
						<div class="form-group">
							<label for="manualFlag">text manualFlag</label> 
							<input type="text" class="form-control" id="manualFlag" name="manualFlag" placeholder="Enter manualFlag">
						</div>
						<div class="form-group">
							<label for="jobDetail">jobDetail</label> 
							<input type="text" class="form-control" id="jobDetail" name="jobDetail" placeholder="Enter jobDetail">
						</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="jobName" name="jobName" placeholder="Enter jobName">
						</div>
						<div class="form-group">
							<label for="createDate">createDate</label> 
							<input type="date" class="form-control" id="createDate" name="createDate" placeholder="createDate">
						</div>
						<div class="form-group">
							<label for="createUser">text createUser</label> 
							<input type="text" class="form-control" id="createUser" name="createUser" placeholder="Enter createUser">
						</div>
						<div class="form-group">
							<label for="inputDate">inputDate</label> 
							<input type="date" class="form-control" id="inputDate" name="inputDate" placeholder="inputDate">
						</div>
						<div class="form-group">
							<label for="tellerId">text tellerId</label> 
							<input type="text" class="form-control" id="tellerId" name="tellerId" placeholder="Enter tellerId">
						</div>
						<div class="form-group">
