...
$(function(){
	...
	$("#exchange").datagrid(
						{   width : "100%",
							...
							method : 'get',
							url : 'publictripAction_editExchangeCustList.do?totalId='+totalId,
							idField : 'id',
							columns : [[
							     		{field:'cust_name',title:'客户名称',width:"20%"},
							     		{field:'id',title:'id',hidden:true},
							     		{field:'cust_id',title:'客户编号',hidden:true},
							            {field : 'industry_classify',title : '行业分类',width :"15%",formatter:function(value,row,index){if(value=='2'){return "交易所";}}},
									...
									onDblClickRow:function(){
										var arr = $('#exchange').datagrid('getSelections');
										$("#win").window("open");
										$("#win").panel({
											title : "查看信息"
										});
							        ...
							        onCheck:function(rowIndex, rowData){
							        	var arr = $('#exchange').datagrid('getSelections');
							        	$('#exchangeType').textbox('setValue',arr.length);
							        },
