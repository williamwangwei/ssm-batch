...
$(function(){
	...
	$("#fund").datagrid(
						{   width : "100%",
							...
							method : 'get',
							url : 'publictripAction_editFundCustList.do?totalId='+totalId,
							idField : 'id',
							columns : [[
							     		{field:'cust_name',title:'客户名称',width:"20%"},
							     		{field:'id',title:'id',hidden:true},
							     		{field:'cust_id',title:'客户编号',hidden:true},
							            {field : 'industry_classify',title : '行业分类',width :"15%",formatter:function(value,row,index){if(value=='4'){return "基金";}}},
									...
									onDblClickRow:function(){
										var arr = $('#fund').datagrid('getSelections');
										$("#win").window("open");
										$("#win").panel({
											title : "查看信息"
										});
							        ...
							        onCheck:function(rowIndex, rowData){
							        	var arr = $('#fund').datagrid('getSelections');
							        	$('#fundType').textbox('setValue',arr.length);
							        },
