...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\t\t\turl : \"");
      out.print(basePath);
      out.write("socket/req\",\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\tdataType : \"json\",\r\n");
      out.write("\t\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\t\t$(\"#recMessage\").textbox('setValue',data.recMessage);\r\n");
      out.write("\t\t\t\t$(\"#respNo\").textbox('setValue',data.seqNo);\r\n");
      out.write("\t\t\t},\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<div class=\"easyui-panel\" title=\"Socket通信测试\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t<div style=\"padding: 10px 60px 20px 60px\">\r\n");
      out.write("\t\t\t\t<form id=\"ff\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"5\" style=\"width: 100%;\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>IP Address:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\" name=\"address\" data-options=\"required:true\" value=\"10.129.34.215\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>PORT:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"easyui-textbox\" type=\"text\" name=\"port\" data-options=\"required:true\" value=\"20096\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t\t&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"easyui-textbox\" type=\"text\" name=\"number\" data-options=\"required:true\" value=\"8\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>Message:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td ><input class=\"easyui-textbox\" name=\"message\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"multiline:true\" style=\"height: 200px;width: 100%;\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t<!-- resp 返回报文 -->\r\n");
      out.write("\t\t<div class=\"easyui-panel\" title=\"Socket通信测试 返回报文\" style=\"width: 100%\">\r\n");
      out.write("\t\t\t<div style=\"padding: 10px 60px 20px 60px\">\r\n");
      out.write("\t\t\t\t\t<table cellpadding=\"5\" style=\"width: 100%;\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>流水号:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"4\"><input class=\"easyui-textbox\" type=\"text\" id=\"respNo\" name=\"respNo\" data-options=\"required:true\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>返回报文:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td >\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"easyui-textbox\" id=\"recMessage\" name=\"recMessage\" data-options=\"multiline:true\" style=\"height: 300px;width: 100%;\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
